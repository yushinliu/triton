...
module attributes {"ttg.compute-capability" = 90 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, "ttg.threads-per-warp" = 32 : i32} {
  tt.func @invalid_shape(%arg0: tensor<128x128xi32, #blocked>) {
    // expected-error @+1 {{result shape cannot exceed replica shape 32, 32 at dimension 0}}
    %0 = ttg.extract_tensor %arg0 [0, 0] : tensor<128x128xi32, #blocked> -> tensor<64x32xi32, #blocked>
    tt.return
  }
}
